...
ENV CONDA_ENV_NAME=planetary-datasets
...
RUN conda create -n ${CONDA_ENV_NAME} python=${PYTHON_VERSION} cartopy eccodes numpy matplotlib rasterio rioxarray datasets gcsfs s3fs adlfs xarray h5netcdf dask satpy[all] -c conda-forge
