...
@dg.asset(
    name="nsrdb-himawari8",
    description="Download NSRDB data for Himawari 8",
    tags={
...
@dg.asset(
    name="nsrdb-goes-10min",
    description="Download NSRDB data for GOES 10min",
    tags={
        "dagster/max_runtime": str(60 * 60 * 10),  # Should take 6 ish hours
        "dagster/priority": "1",
        "dagster/concurrency_key": "download",
...
def nsrdb_mtg_15min_longer_download_asset(
