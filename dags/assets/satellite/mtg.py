...
@dg.asset(name="mtg-fdhi-download", description="Download MTG High Res global geostationary satellites from EUMETSAT",
          tags={
...
@dg.asset(name="mtg-fdlr-download", description="Download MTG Low Res global geostationary satellites from EUMETSAT",
          tags={
              "dagster/max_runtime": str(60 * 60 * 10),  # Should take 6 ish hours
              "dagster/priority": "1",
              "dagster/concurrency_key": "download",
