...
@dg.asset(
    name="silam-dust-download",
    description="Download SILAM 10km dust forecast from FMI Thredds server",
    tags={
...
@dg.asset(
    name="silam-dust-upload-source-coop",
